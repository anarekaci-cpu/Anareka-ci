...
(function(){
  ...
  form.addEventListener('submit', function(e){
    ...
    // Simulation envoi (à remplacer par un vrai backend)
    setTimeout(() => {
...
(function(){
  ...
  function filterCards() {
    ...
    document.querySelectorAll('.membre-card').forEach(card => {
      ...
      const matchF  = activeFilter === 'tous' || type === activeFilter;
      const matchS  = !q || text.includes(q) || ville.includes(q);
      card.classList.toggle('hidden', !(matchF && matchS));
    });
  }
